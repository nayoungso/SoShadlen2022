%function Pulse_2ndVar_cohDep_kendallT_dynamics


path = ['~/Dropbox/plxdata/Pulse/Vprobe/AllCells/']
filename = dir(strcat(path,'*allo*DSP*.mat'))
...
CohDep_31{1,5} = 'sacc1'; CohDep_31{1,6} = 'pursuit'; CohDep_31{1,7} = 'FP2'; CohDep_31{1,8} = 'choice'; 


p_30{1,1} = 'Filename'; p_30{1,2} = 'P1'; p_30{1,3} = 'P2-coh2'; p_30{1,4} = 'P2-sumcoh';
p_30{1,5} = 'sacc1'; p_30{1,6} = 'pursuit'; p_30{1,7} = 'FP2';  p_30{1,8} = 'choice';  


p_31{1,1} = 'Filename'; p_31{1,2} = 'P1'; p_31{1,3} = 'P2-coh2'; p_31{1,4} = 'P2-sumcoh';
p_31{1,5} = 'sacc1'; p_31{1,6} = 'pursuit'; p_31{1,7} = 'FP2'; p_31{1,8} = 'choice'; 
...
P1_time = [-50 500]; pursuit_time = [-400 400];
...
TimeArray{2,1} = 'Sacc1 time'; TimeArray{2,2} = 'n/a in 2nd variant of two-pulse task';
...
for ii = 1:length(filename)
    ...
    for j = 1:length(trials)
        ...
        if (trials(j).taskid==34)&&(trials(j).response>=0)&&(trials(j).mean_maxFR >= 10)    
        ...
        elseif (trials(j).taskid==35)&&(trials(j).response>=0)&&(trials(j).mean_maxFR >= 10)   
    ...
    if trialno_30 > 50
        ...
        [r_30_pursuit, p_30_pursuit] = corr([coh_30(:,1) pursuit_30],'type','kendall');
    ...
    if trialno_31 > 50
        ...
        [r_31_pursuit, p_31_pursuit] = corr([coh_31(:,1) pursuit_31],'type','kendall');
